...
import com.example.javaspringbootboilerplate.dto.request.auth.RegisterRequest;
import com.example.javaspringbootboilerplate.dto.request.auth.ResetPasswordRequest;
import com.example.javaspringbootboilerplate.dto.request.user.AbstractBaseCreateUserRequest;
import com.example.javaspringbootboilerplate.dto.request.user.AbstractBaseUpdateUserRequest;
import com.example.javaspringbootboilerplate.dto.request.user.CreateUserRequest;
import com.example.javaspringbootboilerplate.dto.request.user.UpdatePasswordRequest;
import com.example.javaspringbootboilerplate.dto.request.user.UpdateUserRequest;
import com.example.javaspringbootboilerplate.entity.User;
import com.example.javaspringbootboilerplate.entity.specification.UserFilterSpecification;
import com.example.javaspringbootboilerplate.entity.specification.criteria.PaginationCriteria;
import com.example.javaspringbootboilerplate.entity.specification.criteria.UserCriteria;
import com.example.javaspringbootboilerplate.event.UserEmailVerificationSendEvent;
import com.example.javaspringbootboilerplate.event.UserPasswordResetSendEvent;
import com.example.javaspringbootboilerplate.exception.BadRequestException;
import com.example.javaspringbootboilerplate.exception.NotFoundException;
import com.example.javaspringbootboilerplate.repository.UserRepository;
import com.example.javaspringbootboilerplate.security.JwtUserDetails;
import com.example.javaspringbootboilerplate.util.Constants;
import com.example.javaspringbootboilerplate.util.PageRequestBuilder;
...
public class UserService {
    ...
    public void enableUser(UUID id) {
        ...
        userRepository.save(user);
        log.info("User with id: {} has been enabled", id);
    }
}
